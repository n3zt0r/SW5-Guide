export const nobunaga_chapter3_stage2 = {
    get id() {return `${this.stageNumber}: ${this.stageName}`},
    
    stageNumber: "Stage 2",
    stageName: "Battle of Kannonji Castle",
    stageImage: 'assets/stages/nobunaga_chapter3_stage2.webp',
    objectives: [
        { 
        ...
        { 
            name: "Defeat Kazuuji Nakamura to dispel the Oda Army's confusion",
        ...
        { 
            ...
            tips: 'NOTE: Will not appear if Oichi is a player character. For this one, do the first objective and wait for Kenshin to show up. After he does, approach Yoshiaki and you should see this trigger.'
        },
        { 
            only: "nobunaga_oda",
            type: "bonus",
            name: "By Your Side Once More", 
            description: <span>Nobunaga Oda must work with Mitsuhide Akechi to defeat the enemy troops.</span>,
            tips: 'At the beginning of the stage, you should hear Nobunaga have some dialogue about meeting up with Mitsuhide. Run over there to Mitsuhide, trigger some dialogue, and it should trigger the objective'
        },
        { 
            only: "",
            type: "bonus",
        ...
        { 
            ...
            tips: 'NOTE: Will not appear if Oichi is a player character. After seizing Wadayama Castle, Yoshisada Rokkaku will start talking smack about Nagamasa. Nagamasa will charge in by himself. Approach them to trigger this objective'
        },
        { 
            only: "oichi",
            type: "bonus",
            ...
            tips: 'Replaces "Skilled Men of Rokkaku" when playing as Oichi. During or after "Seizing Wadayama Castle", you should hear some banter between Nagamasa and an enemy. This should trigger easily. You will have two targets around Nagamasa, and one to the southeast. It\'s best to keep the other player away because if Oichi doesn\'t get the kills, you fail the mission'
        },
        ...
        { 
            ...
            tips: 'Replaces "What Must Be Protected" when playing as Oichi. Have Oichi walk over to Yoshiaki and Kenshin\'s general area. You may or may not have to wait for Kenshin to show up after completing first objective'
        },
    ],
