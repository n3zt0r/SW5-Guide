export const nobunaga_chapter4_stage5 = {
    get id() {return `${this.stageNumber}: ${this.stageName}`},
    
    stageNumber: "Stage 5",
    stageName: "Battle of Tonezaka",
    stageImage: 'assets/stages/nobunaga_chapter4_stage5.webp',
    objectives: [
        { 
        ...
        { 
            ...
            tips: 'Replaces "Mitsuki Fights" ( ↓ ). Pretty straightforward I think. I usually leave "Steel Defense" unfinished until you hear Mitsuki\'s dialogue and the applicable bonus objective triggers'
        },
        { 
            only: "mitsuki",
            type: "bonus",
            ...
            tips: 'Replaces "For the Ninja" ( ↑ ). Pretty straightforward I think. I usually leave "Steel Defense" unfinished until you hear Mitsuki\'s dialogue and the applicable bonus objective triggers'
        },
        { 
